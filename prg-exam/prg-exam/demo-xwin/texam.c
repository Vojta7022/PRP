...
{
   save_image_red(WIDTH, HEIGHT, "red.ppm");
   save_image_green(WIDTH, HEIGHT, "green.ppm");
   ...
   for(int i = 0; i < anim; ++i) {
      ...
      /* wait for 10 ms. It is not necessary for visualization of the Julia set, which is computationally demanding */
   }
   xwin_close();
   free(img);
   return EXIT_SUCCESS;
